...
let de_ghost e = Helper.Exp.mk ~loc:(no_ghost e.pexp_loc) e.pexp_desc
...
let exp_int32 loc i =
  Helper.Exp.constant ~loc (Pconst_integer ((Int32.to_string i), (Some 'l')))
let exp_int64 loc i =
  Helper.Exp.constant ~loc (Pconst_integer ((Int64.to_string i), (Some 'L')))
let exp_nativeint loc i =
  Helper.Exp.constant ~loc
    (Pconst_integer ((Nativeint.to_string i), (Some 'n')))
