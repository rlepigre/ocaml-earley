...
and quote_expression_desc e_loc _loc x = match x with
  ...
  | Pexp_fun(x1,x2,x3,x4) -> quote_const e_loc _loc (Ldot(Lident "Parsetree", "Pexp_fun")) [ quote_label e_loc _loc x1; (quote_option quote_expression) e_loc _loc x2; quote_pattern e_loc _loc x3; quote_expression e_loc _loc x4;]
...
and quote_constructor_declaration e_loc _loc r =   quote_record e_loc _loc [
   ...
   ((Ldot(Lident "Parsetree", "pcd_args")), (quote_list quote_core_type) e_loc _loc r.pcd_args) ;
...
and quote_extension_constructor_kind e_loc _loc x = match x with
  | Pext_decl(x1,x2) -> quote_const e_loc _loc (Ldot(Lident "Parsetree", "Pext_decl")) [ (quote_list quote_core_type) e_loc _loc x1; (quote_option quote_core_type) e_loc _loc x2;]
...
and quote_class_type_desc e_loc _loc x = match x with
  ...
  | Pcty_arrow(x1,x2,x3) -> quote_const e_loc _loc (Ldot(Lident "Parsetree", "Pcty_arrow")) [ quote_label e_loc _loc x1; quote_core_type e_loc _loc x2; quote_class_type e_loc _loc x3;]
...
and quote_signature_item_desc e_loc _loc x = match x with
  ...
  | Psig_type(x) -> quote_const e_loc _loc (Ldot(Lident "Parsetree", "Psig_type")) [(quote_list quote_type_declaration) e_loc _loc x]
...
and quote_structure_item_desc e_loc _loc x = match x with
  ...
  | Pstr_type(x) -> quote_const e_loc _loc (Ldot(Lident "Parsetree", "Pstr_type")) [(quote_list quote_type_declaration) e_loc _loc x]
