  ...
  struct
           ...
           Earley.fsequence_position (Earley.string "$uid:" "$uid:")
             (Earley.fsequence expression
                (Earley.sequence (Earley.no_blank_test ())
                   (Earley.char '$' '$')
                   (fun _  _  e  _  __loc__start__buf  __loc__start__pos 
    ...
    let _ =
      Earley.set_grammar tag_name
        (Earley.sequence (Earley.string "`" "`") ident (fun _  c  -> c))
    include struct  end
      ...
      set_module_path_suit
        (fun allow_app  ->
           Earley.alternatives
             ...
             Earley.apply (fun _  acc  -> acc) (Earley.empty ())])
    let _ =
      set_module_path_gen
        (fun allow_app  ->
      ...
      Earley.set_grammar modtype_path
        (Earley.sequence
           (Earley.option None
              (Earley.apply (fun x  -> Some x)
                 (Earley.sequence extended_module_path
                    (Earley.string "." ".") (fun m  _  -> m)))) modtype_name
           (fun mp  mtn  ->
      ...
      Earley.set_grammar classtype_path
        (Earley.sequence
           (Earley.option None
              (Earley.apply (fun x  -> Some x)
                 (Earley.sequence extended_module_path
                    (Earley.string "." ".") (fun m  _  -> m)))) class_name
           (fun mp  cn  ->
              match mp with | None  -> Lident cn | Some p -> Ldot (p, cn)))
    include struct  end
    ...
    let _ =
      Earley.set_grammar attributes
        (Earley.apply List.rev
           (Earley.fixpoint [] (Earley.apply (fun x  y  -> x :: y) attribute)))
    include struct  end
      ...
      Earley.set_grammar poly_syntax_typexpr
        (Earley.fsequence type_kw
           (Earley.fsequence
              (Earley.apply List.rev
                 (Earley.fixpoint1 []
                    (Earley.apply (fun x  y  -> x :: y) typeconstr_name)))
              (Earley.sequence (Earley.string "." ".") typexpr
    ...
    let _ =
      Earley.set_grammar method_type
        (Earley.fsequence_position method_name
        ...
        (Earley.alternatives
           [Earley.fsequence (Earley.string "[>" "[>")
              (Earley.sequence
                 (Earley.apply List.rev
                    (Earley.fixpoint1 []
                       (Earley.apply (fun x  y  -> x :: y) tag_name)))
                 (Earley.string "]" "]") (fun l  _  _  -> l));
                                   ...
                                   [Earley.fsequence_position label_name
                                      (Earley.fsequence (Earley.char ':' ':')
                                         (Earley.fsequence
                                            ...
                                            (Earley.sequence arrow_re
                                               (typexpr_lvl Arr)
                                               (fun _default_0  te'  te  _ 
                                                  ln  __loc__start__buf 
                                                  __loc__start__pos 
                                                  __loc__end__buf 
                                                  __loc__end__pos  ->
                                                  let _loc =
             ...
             (Earley.fsequence type_param
                (Earley.sequence
                   (Earley.apply List.rev
                      (Earley.fixpoint []
                         (Earley.apply (fun x  y  -> x :: y)
                            (Earley.sequence (Earley.char ',' ',') type_param
                               (fun _  tp  -> tp))))) (Earley.char ')' ')')
    ...
    let _ =
      Earley.set_grammar type_equation
        (Earley.fsequence (Earley.char '=' '=')
           (Earley.sequence private_flag typexpr (fun p  te  _  -> (p, te))))
    include struct  end
                                    ...
                                    (Earley.fixpoint []
                                       (Earley.apply (fun x  y  -> x :: y)
                                          (Earley.sequence
                                             ...
                                             (fun _  _default_0  ->
                                                _default_0))))) arrow_re
                                 (fun tes  _default_0  te  -> te :: tes))))
                        (typexpr_lvl (next_type_prio Arr))
                        (fun tes  te  _  -> (tes, (Some te))))])
                (fun cn  ->
                   let (_loc_cn,cn) = cn in
                   fun ((tes,te) as _default_0)  _default_1 
                     ...
                     constructor_declaration
                       ~attributes:(attach_attrib ~local:true _loc []) _loc c
                       tes te)))
    include struct  end
      ...
      set_grammar constr_decl_list
        (Earley.alternatives
           [Earley.sequence (all_constr_decl false)
              ...
              (fun cd  cds  -> List.flatten (cd :: cds));
           Earley.apply (fun _  -> []) (Earley.empty ())])
      ...
      Earley.set_grammar type_information
        (Earley.fsequence
           ...
           (Earley.sequence
              ...
              (Earley.apply List.rev
                 (Earley.fixpoint []
                    (Earley.apply (fun x  y  -> x :: y) type_constraint)))
              (fun ptr  cstrs  te  ->
                 let (pri,tkind) =
                   match ptr with
                 ...
                 (Earley.fixpoint []
                    (Earley.apply (fun x  y  -> x :: y)
                       (Earley.sequence
                          (Earley.apply_position
                             (fun x  str  pos  str'  pos'  ->
                                ((locate str pos str' pos'), x)) and_kw)
                          typedef
                          (fun l  ->
                             let (_loc_l,l) = l in
                             fun td  -> td (Some _loc_l))))))
              (fun td  tds  l  ->
                 let (_loc_l,l) = l in (td (Some _loc_l)) :: tds)))
    include struct  end
    ...
    let _ =
      Earley.set_grammar virt_mut
        (Earley.alternatives
           [Earley.sequence virtual_flag mutable_flag (fun v  m  -> (v, m));
    ...
    let _ =
      Earley.set_grammar virt_priv
        (Earley.alternatives
           [Earley.sequence virtual_flag private_flag (fun v  p  -> (v, p));
        ...
        (Earley.alternatives
           [Earley.fsequence (Earley.char '~' '~')
              (Earley.sequence
                 (Earley.apply_position
                    (fun x  str  pos  str'  pos'  ->
                       ((locate str pos str' pos'), x)) lident) no_colon
                 (fun id  ->
                    let (_loc_id,id) = id in
                    fun _default_0  _  ->
                      ((labelled id),
                      ...
                      (Earley.fsequence (Earley.no_blank_test ())
                         (Earley.sequence (Earley.char '$' '$')
                            (Earley.option []
                               (Earley.sequence and_kw let_binding
                                  (fun _  _default_0  -> _default_0)))
                            (fun _  l  _  e  aq  _  dol  __loc__start__buf 
                               __loc__start__pos  __loc__end__buf 
                               __loc__end__pos  ->
                               let _loc =
                                 locate __loc__start__buf __loc__start__pos
                               ...
                               let open Quote in
                                 let generic_antiquote e =
                                   function
                                   | Quote_loc  -> e
                                   | _ -> failwith "invalid antiquotation" in
                                 let f =
                                   match aq with
             ...
             (Earley.fsequence (Earley.no_blank_test ())
                (Earley.fsequence
                   ...
                   (Earley.fsequence expression
                      (Earley.sequence (Earley.no_blank_test ())
                         (Earley.char '$' '$')
                         (fun _  _  e  aq  _  _  __loc__start__buf 
                            __loc__start__pos  __loc__end__buf 
                            __loc__end__pos  ->
                            let _loc =
                              locate __loc__start__buf __loc__start__pos
        ...
        (Earley.alternatives
           ...
           Earley.fsequence_position fun_kw
             (Earley.fsequence
                (Earley.apply List.rev
                   (Earley.fixpoint1 []
                      (Earley.apply (fun x  y  -> x :: y) (parameter false))))
        ...
        (Earley.sequence_position class_expr_base
           (Earley.option None
              (Earley.apply (fun x  -> Some x)
                 (Earley.apply List.rev
                    (Earley.fixpoint1 []
                       (Earley.apply (fun x  y  -> x :: y) argument)))))
    ...
    let _ =
      set_grammar class_body
        (Earley.sequence
           ...
           (Earley.apply List.rev
              (Earley.fixpoint []
                 (Earley.apply (fun x  y  -> x :: y) class_field)))
           (fun p  ->
              let (_loc_p,p) = p in
              fun f  ->
                let p =
           ...
           Earley.alternatives
             [Earley.sequence_position function_kw match_cases
                (fun _default_0  l  __loc__start__buf  __loc__start__pos 
                   ...
                   {
                     Parsetree.pexp_desc =
                       (Parsetree.Pexp_function ("", None, l));
                     Parsetree.pexp_loc = _loc
                   });
                     ...
                     (fun _default_0  l  e  _default_1  __loc__start__buf 
                        ...
                        let _loc =
                          locate __loc__start__buf __loc__start__pos
                            __loc__end__buf __loc__end__pos in
                        {
                          Parsetree.pexp_desc = (Parsetree.Pexp_match (e, l));
                          Parsetree.pexp_loc = _loc
                        })));
                     ...
                     (fun _default_0  l  e  _default_1  __loc__start__buf 
                        ...
                        let _loc =
                          locate __loc__start__buf __loc__start__pos
                            __loc__end__buf __loc__end__pos in
                        {
                          Parsetree.pexp_desc = (Parsetree.Pexp_try (e, l));
                          Parsetree.pexp_loc = _loc
                        })));
                  ...
                  (Earley.fsequence then_kw
                     (Earley.sequence (expression_lvl (alm, (next_exp Seq)))
                        ...
                        (fun e  _default_0  _default_1  c  _default_2 
                           ...
                           {
                             Parsetree.pexp_desc =
                               (Parsetree.Pexp_ifthenelse (c, e, None));
                             Parsetree.pexp_loc = _loc
                           }))))])
    include struct  end
    let _ =
                  ...
                  then
                    [Earley.fsequence_position
                       ...
                       (Earley.sequence
                          ...
                          (fun e'  _default_0  ls  __loc__start__buf 
                             __loc__start__pos  __loc__end__buf 
                             __loc__end__pos  ->
                             let _loc =
                               locate __loc__start__buf __loc__start__pos
             ...
             (Earley.alternatives
                ...
                Earley.fsequence type_kw
                  (Earley.fsequence
                     ...
                     (Earley.sequence (Earley.string "=" "=") module_type
                        (fun _  mt  mn  ->
                           let (_loc_mn,mn) = mn in
                           fun _default_0  ->
           ...
           Earley.fsequence structure_item_aux
             (Earley.fsequence double_semi_col
                (Earley.sequence ext_attributes
                   ...
                   (fun _  e  ->
                      let (_loc_e,e) = e in
                      fun _default_0  s1  -> (loc_str _loc_e (pstr_eval e))
                        :: (List.rev_append (attach_str _loc_e) s1))))])
    include struct  end
    let _ =
    ...
    let _ =
      set_grammar structure_item_simple
        (Earley.apply List.rev
           (Earley.fixpoint []
              (Earley.apply (fun x  y  -> x :: y) structure_item_base)))
           ...
           Earley.fsequence_position (Earley.char '$' '$')
             (Earley.fsequence (Earley.no_blank_test ())
                (Earley.fsequence expression
                   (Earley.sequence (Earley.no_blank_test ())
                      (Earley.char '$' '$')
                      (fun _  _  e  _  dol  __loc__start__buf 
                         __loc__start__pos  __loc__end__buf  __loc__end__pos 
                         ->
                         let _loc =
                           locate __loc__start__buf __loc__start__pos
      ...
      set_grammar signature_item
        (Earley.alternatives
           ...
           Earley.sequence
             (Earley.apply_position
                (fun x  str  pos  str'  pos'  ->
                   ((locate str pos str' pos'), x)) signature_item_base)
             (Earley.option None
      ...
      Earley.set_grammar top_phrase
        (Earley.alternatives
           ...
           Earley.sequence
             (Earley.option None
                (Earley.apply (fun x  -> Some x) (Earley.char ';' ';')))
             (Earley.eof ()) (fun _default_0  _  -> raise Top_Exit)])
    include struct  end
  end
