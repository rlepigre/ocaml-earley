  ...
  struct
        ...
        | (name,arg,ty,r)::l ->
            ...
            (match arg with
             | None  ->
                 ...
                 let ev =
                   loc_expr _loc
                     (Pexp_apply (dsg, [(nolabel, name); (nolabel, r)])) in
             ...
             | Some arg ->
                 ...
                 let strname =
                   loc_expr _loc (Pexp_constant (const_string name)) in
                 let sname =
                   loc_expr _loc (Pexp_ident (id_loc (Lident set_name) _loc)) in
                 ...
                 (((loc_str _loc (Pstr_value (Nonrecursive, [l]))) :: str1),
                   ((loc_str _loc (pstr_eval ev)) :: str2))) in
      ...
      Earley.set_grammar glr_sequence
        (Earley.alternatives
           ...
           Earley.sequence_position (Earley.string "EOF" "EOF") glr_opt_expr
             (fun _  oe  __loc__start__buf  __loc__start__pos 
           ...
           Earley.fsequence_position (Earley.string "CHR" "CHR")
             (Earley.sequence expr_arg glr_opt_expr
                (fun e  oe  _  __loc__start__buf  __loc__start__pos 
                   __loc__end__buf  __loc__end__pos  ->
                   let _loc =
           ...
           Earley.sequence_position char_litteral glr_opt_expr
             (fun c  oe  __loc__start__buf  __loc__start__pos 
                __loc__end__buf  __loc__end__pos  ->
                let _loc =
                  locate __loc__start__buf __loc__start__pos __loc__end__buf
                    __loc__end__pos in
           ...
           Earley.sequence_position string_litteral glr_opt_expr
             (fun s  oe  __loc__start__buf  __loc__start__pos 
                __loc__end__buf  __loc__end__pos  ->
                let _loc =
                  locate __loc__start__buf __loc__start__pos __loc__end__buf
                    __loc__end__pos in
                                     ...
                                     (Parsetree.Pexp_ident
                                        {
                                          Asttypes.txt =
                                            (Longident.Ldot
                                               ((Longident.Lident "EarleyStr"),
                                                 "regexp"));
                                          Asttypes.loc = _loc
                                        });
                                   Parsetree.pexp_loc = _loc
                                 },
                                  [("name", (Pa_ast.exp_string _loc id));
                                  ("", e);
                                  ("", act)]));
                           Parsetree.pexp_loc = _loc
                         })
           ...
           Earley.sequence_position dash glr_opt_expr
             (fun _default_0  oe  __loc__start__buf  __loc__start__pos 
                __loc__end__buf  __loc__end__pos  ->
                let _loc =
                  locate __loc__start__buf __loc__start__pos __loc__end__buf
                    __loc__end__pos in
           ...
           Earley.sequence_position new_regexp_litteral glr_opt_expr
             (fun s  opt  __loc__start__buf  __loc__start__pos 
                __loc__end__buf  __loc__end__pos  ->
                let _loc =
                  locate __loc__start__buf __loc__start__pos __loc__end__buf
                    __loc__end__pos in
                 ...
                 (Earley.fsequence glr_ident
                    (Earley.sequence glr_sequence glr_option
                       (fun ((cst,s) as _default_0)  opt 
                          ...
                          `Normal
                            (id, (from_opt cst' ((opt <> `Once) || cst)), s,
                              opt)))))))
    let _ =
    ...
    let _ =
      Earley.set_grammar glr_cond
        (Earley.option None
           (Earley.apply (fun x  -> Some x)
              (Earley.sequence when_kw expression (fun _  e  -> e))))
    let _ =
