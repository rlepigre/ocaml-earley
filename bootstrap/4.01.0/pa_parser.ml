                 ...
                 ([{
                  ...
                  Pa_ast.loc_str _loc
                   ...
                   Pa_ast.loc_str _loc
                     (Parsetree.Pstr_include
                        (Pa_ast.mexpr_loc _loc
                           (Parsetree.Pmod_structure str2)))])) in
            ...
            include
              struct
                ...
                include
                  struct
                    let glr_left_member =
                      Earley.declare_grammar "glr_left_member"
                    include
                      struct
                                ...
                                include
                                  struct
                                    let (glr_rule,glr_rule__set__grammar) =
                                      Earley.grammar_family "glr_rule"
                                    include
                                      struct
                                        let glr_rules =
                                          Earley.declare_grammar "glr_rules"
                                        include struct  end
                                      end
                                  end
                              end
                ...
                let _ =
                  Earley.set_grammar glr_ident
                    (Earley.alternatives
                       ...
                       Earley.apply (fun _  -> (None, ("_", None)))
                         (Earley.empty ())])
                include
                  struct
                    let _ =
                                       ...
                                       Earley.alternatives
                                         ...
                                         Earley.fsequence arrow_re
                                           (Earley.sequence
                                              ...
                                              no_semi
                                              (fun action  _default_0 
                                                 _default_1  -> Normal action));
                                         Earley.apply (fun _  -> Default)
                                           (Earley.empty ())])
                                include
                                  struct
                                    let _ =
                                      glr_rule__set__grammar
                                        (fun alm  ->
                                           Earley.fsequence_position glr_let
                                             (Earley.fsequence
                                                glr_left_member
                                                (Earley.sequence glr_cond
                                                   (glr_action alm)
                                                   (fun condition  action  l 
                                                      def  __loc__start__buf 
                                                      __loc__start__pos 
                                                      __loc__end__buf 
                                                      __loc__end__pos  ->
                                                      let _loc =
