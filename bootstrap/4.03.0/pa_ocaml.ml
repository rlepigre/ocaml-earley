  ...
  struct
    ...
    let _ =
      set_typexpr_lvl
        ([(((fun _  -> true)),
                                        ...
                                        fun __loc__end__pos  ->
                                          let _loc =
                                            locate __loc__start__buf
                                              ...
                                              __loc__end__buf __loc__end__pos
                                             in
                                          Typ.arrow ~loc:_loc (labelled ln)
                                            te te'))))));
         (((fun (allow_par,lvl)  -> lvl <= Arr)),
           (Earley.fsequence_position (typexpr_lvl ProdType)
              (Earley.sequence arrow_re (typexpr_lvl Arr)
                 (fun _default_0  ->
                    fun te'  ->
                      fun te  ->
         ...
         (((fun _  -> true)),
           (Earley.fsequence_position (Earley.char '<' '<')
              (Earley.sequence op_cl (Earley.char '>' '>')
                 (fun rv  ->
                    fun _  ->
                      fun _  ->
                        fun __loc__start__buf  ->
        ...
        (Earley.alternatives
           [Earley.sequence opt_variance
              (Earley.apply_position
                 ...
                 (Earley.char '_' '_'))
              (fun var  ->
                 fun j  -> let (_loc_j,j) = j  in ((Joker _loc_j), var));
           Earley.sequence opt_variance
             (Earley.apply_position
                (fun x  ->
                   fun str  ->
             ...
             (fun var  ->
                fun id  ->
                  let (_loc_id,id) = id  in ((Name (id_loc id _loc_id)), var))])
    ...
    let _ =
      Earley.set_grammar constr_extn_list
        (Earley.alternatives
           [Earley.apply (fun _  -> []) (Earley.empty ());
           Earley.sequence (type_constr_extn false)
             (Earley.apply List.rev
                (Earley.fixpoint []
                   (Earley.apply (fun x  -> fun y  -> x :: y)
           ...
           Earley.fsequence_position (Earley.char '$' '$')
             (Earley.fsequence (Earley.no_blank_test ())
                (Earley.fsequence (expression_lvl (NoMatch, App))
                   (Earley.fsequence (Earley.no_blank_test ())
                      (Earley.sequence (Earley.char '$' '$') constr_extn_list
                         (fun _  ->
                            fun cds  ->
                              fun _  ->
                                fun e  ->
                                ...
                                fun __loc__end__pos  ->
                                  let _loc =
                                    locate __loc__start__buf
                                     ...
                                     in
                                  label_declaration
                                    ~attributes:(attach_attrib _loc []) _loc
              ...
              (Earley.fsequence
                 ...
                 (Earley.fsequence (Earley.string "+=" "+=")
                    (Earley.fsequence private_flag
                       (Earley.sequence constr_extn_list post_item_attributes
                          (fun cds  ->
                             fun attrs  ->
                               fun priv  ->
                                 fun _  ->
      ...
      Earley.set_grammar class_spec
        (Earley.fsequence_position virtual_flag
           (Earley.fsequence
              (Earley.option []
                 (Earley.fsequence (Earley.string "[" "[")
                    (Earley.sequence type_parameters (Earley.string "]" "]")
                 ...
                 (Earley.fixpoint []
                    (Earley.apply (fun x  -> fun y  -> x :: y)
                       (Earley.sequence and_kw class_spec
                          (fun _  -> fun _default_0  -> _default_0)))))
              (fun cs  -> fun css  -> fun _default_0  -> cs :: css)))
                                   ...
                                   fun __loc__end__buf  ->
                                     fun __loc__end__pos  ->
                                       ...
                                       fun _loc  ->
                                         class_type_declaration
                                           ~attributes:(attach_attrib _loc [])
                                           _loc (id_loc cn _loc_cn) params v
                                           cbt)))))
           ...
           (Earley.apply_position
              (fun x  ->
                 fun str  ->
                   fun pos  ->
                     fun str'  ->
                       fun pos'  -> ((locate str pos str' pos'), x)) class_kw)
           (Earley.fsequence type_kw
              (Earley.sequence
                 (Earley.apply_position
                    (fun x  ->
                 ...
                 (Earley.apply List.rev
                    (Earley.fixpoint []
                       (Earley.apply (fun x  -> fun y  -> x :: y)
                          (Earley.sequence_position and_kw classtype_def
                             (fun _  ->
                                fun cd  ->
                                  fun __loc__start__buf  ->
                                    fun __loc__start__pos  ->
                 ...
                 (fun cd  ->
                    ...
                    fun cds  ->
                      fun _default_0  ->
                        fun k  ->
                          let (_loc_k,k) = k  in (cd (merge2 _loc_k _loc_cd))
                            :: cds))))
                                       ...
                                       fun _  ->
                                         fun vn  ->
                                           ...
                                           let loc = merge2 _loc_vn _loc_e
                                              in
                                           let (e,ty) =
                                             wrap_type_annotation loc ids ty
                                               e
                                              in
                                           let pat =
                                             loc_pat (ghost loc)
                      ...
                      fun str  ->
                        fun pos  ->
                          fun str'  ->
                            fun pos'  -> ((locate str pos str' pos'), x))
                   (Earley.fsequence override_flag
                      (Earley.sequence private_flag method_name
                         (fun _default_1  ->
                            fun _default_0  ->
                              fun _default_2  ->
                                            ...
                                            fun __loc__end__pos  ->
                                              let _loc =
                                                locate __loc__start__buf
                                                  ...
                                                  __loc__end__pos
                                                 in
                                              let _loc_e = merge2 _loc_t _loc
                                                 in
                                              let (e,poly) =
                                                wrap_type_annotation _loc_e
                                                  ids te e
                                                 in
                                              let e =
                                                loc_expr (ghost _loc_e)
                                                  (Pexp_poly (e, (Some poly)))
                                                 in
                                              loc_pcf _loc
                                                (Pcf_method
                                                   (mn, p,
                                            ...
                                            fun __loc__end__pos  ->
                                              ...
                                              (let e =
                                                 ...
                                                 | Some te ->
                                                  ...
                                                  in
                                               let e : expression =
                                                 apply_params ~gh:true _loc_e
                                                   ps e
                                                  in
                                               let e =
                                                 loc_expr
                                                   (ghost
                                                      (merge2 _loc_t _loc_e))
                                                   (Pexp_poly (e, None))
                                                  in
                                               loc_pcf _loc
                                                 (Pcf_method
                                               ...
                                               fun __loc__end__pos  ->
                                                 let _loc =
                                                   locate __loc__start__buf
                                                    ...
                                                    in
                                                 let ce =
                                                   apply_params_cls ~gh:true
                                                     (merge2 _loc_ps _loc) ps
                                                     ce
                                                    in
                                                 let ce =
                                                   match ct with
        ...
        (Earley.fsequence
           ...
           (Earley.sequence
              ...
              (Earley.apply List.rev
                 (Earley.fixpoint []
                    (Earley.apply (fun x  -> fun y  -> x :: y)
                       (Earley.sequence_position and_kw class_binding
                          (fun _  ->
                             fun cb  ->
                               fun __loc__start__buf  ->
                                 fun __loc__start__pos  ->
        ...
        ([(((fun lvl  -> lvl <= Atom)),
         ...
         (((fun lvl  -> lvl <= Dash)),
           (Earley.fsequence_position (expression_lvl (NoMatch, Dash))
              (Earley.sequence (Earley.char '#' '#') method_name
                 (fun _  ->
                    fun f  ->
                      fun e'  ->
                        fun __loc__start__buf  ->
                      ...
                      fun __loc__end__pos  ->
                        let _loc =
                          locate __loc__start__buf __loc__start__pos
                            __loc__end__buf __loc__end__pos
                           in
                        Str.type_ ~loc:_loc Recursive td) type_definition;
           Earley.apply_position
             (fun te  ->
                fun __loc__start__buf  ->
                  fun __loc__start__pos  ->
                      ...
                      fun __loc__end__pos  ->
                        let _loc =
                          locate __loc__start__buf __loc__start__pos
                            __loc__end__buf __loc__end__pos
                           in
                        Str.type_extension ~loc:_loc te) type_extension;
           Earley.apply_position
             (fun ex  ->
                fun __loc__start__buf  ->
                  fun __loc__start__pos  ->
                      ...
                      fun __loc__end__pos  ->
                        let _loc =
                          locate __loc__start__buf __loc__start__pos
                            __loc__end__buf __loc__end__pos
                           in
                        loc_str _loc (Pstr_class_type ctd))
                      ...
                      fun __loc__end__pos  ->
                        let _loc =
                          locate __loc__start__buf __loc__start__pos
                            __loc__end__buf __loc__end__pos
                           in
                        loc_str _loc (Pstr_class cds)) class_definition;
           Earley.apply_position
             (fun ((s,l) as _default_0)  ->
                fun __loc__start__buf  ->
                  fun __loc__start__pos  ->
                      ...
                      fun __loc__end__pos  ->
                        let _loc =
                          locate __loc__start__buf __loc__start__pos
                            __loc__end__buf __loc__end__pos
                           in
                        Sig.type_ ~loc:_loc Recursive td) type_definition;
           Earley.apply_position
             (fun te  ->
                fun __loc__start__buf  ->
                  fun __loc__start__pos  ->
                      ...
                      fun __loc__end__pos  ->
                        let _loc =
                          locate __loc__start__buf __loc__start__pos
                            __loc__end__buf __loc__end__pos
                           in
                        Sig.type_extension ~loc:_loc te) type_extension;
           Earley.sequence_position exception_kw (constr_decl false)
             (fun _default_1  ->
                fun ((name,args,res,a) as _default_0)  ->
                  fun __loc__start__buf  ->
                      ...
                      fun __loc__end__pos  ->
                        let _loc =
                          locate __loc__start__buf __loc__start__pos
                            __loc__end__buf __loc__end__pos
                           in
                        loc_sig _loc (Psig_class_type ctd))
             classtype_definition;
           Earley.apply_position
             (fun cs  ->
                fun __loc__start__buf  ->
                      ...
                      fun __loc__end__pos  ->
                        let _loc =
                          locate __loc__start__buf __loc__start__pos
                            __loc__end__buf __loc__end__pos
                           in
                        loc_sig _loc (Psig_class cs)) class_specification;
           Earley.apply_position
             (fun ((s,l) as _default_0)  ->
                fun __loc__start__buf  ->
                  fun __loc__start__pos  ->
