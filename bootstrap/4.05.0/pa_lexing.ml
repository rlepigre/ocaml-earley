...
let int_litteral =
  (let int_re =
   ...
   Earley.sequence
     ...
     num_suffix (fun i  -> fun _default_0  -> (i, _default_0)) : (string *
                                                                   char
                                                                   option)
                                                                   Earley.grammar)
...
let float_litteral =
  (let float_re =
   ...
   Earley.sequence
     ...
     num_suffix (fun f  -> fun _default_0  -> (f, _default_0)) : (string *
                                                                   char
                                                                   option)
                                                                   Earley.grammar)
...
let string_litteral =
  (Earley.change_layout
     ...
     Earley.no_blank : (string * string option) Earley.grammar)
  ...
  (let char_reg = "[^'\\\\]"  in
   ...
   let internal =
     Earley.fsequence (Earley.string "{#" "{#")
      ...
      in
   Earley.change_layout internal Earley.no_blank : string Earley.grammar)
