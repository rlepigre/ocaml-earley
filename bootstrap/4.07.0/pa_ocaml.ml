    ...
    let _ =
      module_path_suit_aux__set__grammar
        (fun allow_app ->
           Earley.alternatives
             ((Earley.fsequence (Earley.string "." ".")
                 (Earley.apply (fun m -> fun _ -> fun acc -> Ldot (acc, m))
                    smodule_name)) ::
             ((if allow_app
               then
                 [Earley.fsequence (Earley.string "(" "(")
        ...
        (Earley.fsequence (Earley.string "[@" "[@")
           (Earley.fsequence attr_id
              (Earley.fsequence payload
                 (Earley.apply (fun _ -> fun p -> fun id -> fun _ -> (id, p))
                    (Earley.char ']' ']')))))
      ...
      Earley.set_grammar method_type
        (Earley.alternatives
           ...
           Earley.fsequence method_name
             (Earley.fsequence (Earley.char ':' ':')
                (Earley.apply
                   (fun pte -> fun _ -> fun mn -> Otag (mn, [], pte))
                   poly_typexpr))])
                ...
                (Earley.fsequence
                   (Earley.apply List.rev
                      (Earley.fixpoint []
                         (Earley.apply (fun x -> fun y -> x :: y)
                            (Earley.fsequence (Earley.char '|' '|')
                               (Earley.apply (fun ts -> fun _ -> ts) tag_spec)))))
                   (Earley.apply_position
                      (fun __loc__start__buf ->
                         fun __loc__start__pos ->
                           fun __loc__end__buf ->
                            ...
                            fun __loc__end__buf ->
                              fun __loc__end__pos ->
                                ...
                                fun te' ->
                                  fun _default_0 ->
                                    fun te ->
                                      fun ln -> Typ.arrow ~loc:_loc ln te te')
                       (typexpr_lvl Arr))))));
         (((fun (allow_par, lvl) -> lvl <= Arr)),
                       ...
                       fun __loc__start__pos ->
                         fun __loc__end__buf ->
                           fun __loc__end__pos ->
                             ...
                             fun te' ->
                               fun _default_0 ->
                                 fun te -> Typ.arrow ~loc:_loc nolabel te te')
                    (typexpr_lvl Arr)))));
         (((fun _ -> true)),
           (Earley.apply_position
              (fun __loc__start__buf ->
                 ...
                 (Earley.fsequence
                    (Earley.apply List.rev
                       (Earley.fixpoint1 []
                          (Earley.apply (fun x -> fun y -> x :: y)
                             (Earley.fsequence (Earley.char ',' ',')
                                (Earley.apply (fun te -> fun _ -> te) typexpr)))))
                    (Earley.fsequence (Earley.char ')' ')')
                       (Earley.apply_position
                          (fun __loc__start__buf ->
                             fun __loc__start__pos ->
                           ...
                           fun __loc__end__pos ->
                             let _loc =
                               locate __loc__start__buf __loc__start__pos
                                 __loc__end__buf __loc__end__pos in
                             fun _ ->
                               fun rv -> fun _ -> Typ.object_ ~loc:_loc [] rv)
                    (Earley.char '>' '>')))));
         (((fun _ -> true)),
           (Earley.fsequence (Earley.char '<' '<')
    ...
    let _ =
      Earley.set_grammar type_representation
        (Earley.alternatives
           ...
           Earley.fsequence (Earley.string "{" "{")
             (Earley.fsequence field_decl_list
                (Earley.apply (fun _ -> fun fds -> fun _ -> Ptype_record fds)
                   (Earley.string "}" "}")));
           Earley.apply
                       ...
                       fun __loc__end__pos ->
                         let _loc =
                           locate __loc__start__buf __loc__start__pos
                             __loc__end__buf __loc__end__pos in
                         fun cbt ->
                           fun _default_0 -> pctf_loc _loc (Pctf_inherit cbt))
                class_body_type);
                ...
                (Earley.apply_position
                   ...
                   (Earley.option None
                      (Earley.apply (fun x -> Some x)
                         (Earley.fsequence (Earley.string "(" "(")
                            (Earley.fsequence typexpr
                               (Earley.apply (fun _ -> fun te -> fun _ -> te)
                                  (Earley.string ")" ")")))))))
                (Earley.fsequence
                   (Earley.apply List.rev
                      (Earley.fixpoint []
              ...
              (Earley.fixpoint []
                 (Earley.apply (fun x -> fun y -> x :: y)
                    (Earley.fsequence
                       ...
                       (Earley.fsequence (Earley.string ":" ":")
                          (Earley.apply (fun te -> fun _ -> fun l -> (l, te))
                             typexpr))))))
           (Earley.apply_position
              (fun __loc__start__buf ->
                 fun __loc__start__pos ->
              ...
              (Earley.option []
                 (Earley.fsequence (Earley.string "[" "[")
                    (Earley.fsequence type_parameters
                       (Earley.apply (fun _ -> fun params -> fun _ -> params)
                          (Earley.string "]" "]")))))
              (Earley.fsequence
                 (Earley.apply_position
                    (fun str ->
                      ...
                      fun __loc__end__buf ->
                        fun __loc__end__pos ->
                          let _loc =
                            locate __loc__start__buf __loc__start__pos
                              __loc__end__buf __loc__end__pos in
                          fun p -> fun c -> Pat.variant ~loc:_loc c (Some p))
                 (pattern_lvl (false, ConstrPat)))));
         (((fun _ -> true)),
           (Earley.apply_position
              (fun __loc__start__buf ->
                          ...
                          fun __loc__start__pos ->
                            fun __loc__end__buf ->
                              fun __loc__end__pos ->
                                ...
                                fun _ ->
                                  fun _default_0 ->
                                    fun ps -> fun _ -> Pat.array ~loc:_loc ps)
                       (Earley.string "|]" "|]"))))));
         (((fun _ -> true)),
           (Earley.fsequence (Earley.char '(' '(')
              (Earley.apply_position
           ...
           (Earley.option None
              (Earley.apply (fun x -> Some x)
                 (Earley.fsequence (Earley.char ':' ':')
                    (Earley.apply (fun t -> fun _ -> t) typexpr))))
           (Earley.fsequence (Earley.char '=' '=')
              (Earley.apply (fun e -> fun _ -> fun ty -> (ty, e)) expression)))
    let _ =
                                     ...
                                     fun pat ->
                                       ...
                                       let (pat, e) =
                                         ...
                                         | Some ty ->
                                             ...
                                             let poly_ty =
                                               Typ.poly ~loc:(ghost _loc) []
                                                 ty in
                                             ((Pat.constraint_ ~loc pat
                                                 poly_ty),
           ...
           Earley.fsequence
             ...
             (Earley.fsequence
                ...
                (Earley.fsequence (match_case Match Seq)
                   (Earley.apply
                      (fun _default_0 ->
                         fun x -> fun l -> fun _default_1 -> l @ [x]) no_semi)));
           Earley.apply (fun _ -> []) (Earley.empty ())])
                ...
                (Earley.fixpoint []
                   (Earley.apply (fun x -> fun y -> x :: y)
                      (Earley.fsequence record_item
                         (Earley.apply
                            (fun _ -> fun _default_0 -> _default_0) semi_col)))))
             (Earley.fsequence last_record_item
                (Earley.apply (fun _default_0 -> fun it -> fun l -> l @ [it])
                   (Earley.option None
                      (Earley.apply (fun x -> Some x) semi_col))))])
                       ...
                       fun __loc__end__pos ->
                         let _loc =
                           locate __loc__start__buf __loc__start__pos
                             __loc__end__buf __loc__end__pos in
                         fun e ->
                           fun _default_0 -> loc_pcf _loc (Pcf_initializer e))
                expression);
           Earley.apply_position
             (fun __loc__start__buf ->
                fun __loc__start__pos ->
                                             ...
                                             fun str' ->
                                               fun pos' ->
                                                 fun x ->
                                                   ((locate str pos str' pos'),
                                                     x)) module_expr))))))])
                 (Earley.apply (fun _ -> fun f -> fun _ -> (Seq, false, f))
                    in_kw))));
              ...
              (Earley.fsequence
                 (Earley.option None
                    (Earley.apply (fun x -> Some x)
                       (Earley.fsequence expression
                          (Earley.apply
                             (fun _ -> fun _default_0 -> _default_0) with_kw))))
                 (Earley.fsequence record_list
                    (Earley.apply_position
                       (fun __loc__start__buf ->
                          fun __loc__start__pos ->
                                ...
                                (Earley.apply (fun x -> fun y -> x :: y)
                                   (Earley.fsequence semi_col
                                      (Earley.apply (fun o -> fun _ -> o)
                                         obj_item)))))
                          (Earley.apply (fun _ -> fun l -> fun o -> o :: l)
                             (Earley.option None
                                (Earley.apply (fun x -> Some x) semi_col))))))
                 (Earley.apply_position
                    (fun __loc__start__buf ->
             ...
             (Earley.fsequence module_expr
                (Earley.fsequence
                   (Earley.option None
                      (Earley.apply (fun x -> Some x)
                         (Earley.fsequence (Earley.char ':' ':')
                            (Earley.apply (fun mt -> fun _ -> mt) module_type))))
                   (Earley.apply_position
                      (fun __loc__start__buf ->
                         fun __loc__start__pos ->
                           fun __loc__end__buf ->
                 ...
                 (Earley.apply (fun x -> Some x)
                    (Earley.fsequence with_kw
                       (Earley.fsequence mod_constraint
                          (Earley.apply (fun l -> fun m -> fun _ -> m :: l)
                             (Earley.apply List.rev
                                (Earley.fixpoint []
                                   (Earley.apply (fun x -> fun y -> x :: y)
                                      (Earley.fsequence and_kw
